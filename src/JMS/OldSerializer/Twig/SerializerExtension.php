...
namespace JMS\OldSerializer\Twig;

use JMS\OldSerializer\SerializerInterface;
use JMS\OldSerializer\SerializationContext;
...
class SerializerExtension extends \Twig_Extension
{
    ...
    {
        return array(
            new \Twig_SimpleFunction('serialization_context', '\JMS\OldSerializer\SerializationContext::create'),
        );
    }
