...
namespace JMS\OldSerializer\Metadata\Driver;

use JMS\OldSerializer\Annotation\Discriminator;
use JMS\OldSerializer\GraphNavigator;
use JMS\OldSerializer\Annotation\HandlerCallback;
use JMS\OldSerializer\Annotation\AccessorOrder;
use JMS\OldSerializer\Annotation\Accessor;
use JMS\OldSerializer\Annotation\AccessType;
use JMS\OldSerializer\Annotation\XmlMap;
use JMS\OldSerializer\Annotation\XmlRoot;
use JMS\OldSerializer\Annotation\XmlNamespace;
use JMS\OldSerializer\Annotation\XmlAttribute;
use JMS\OldSerializer\Annotation\XmlList;
use JMS\OldSerializer\Annotation\XmlValue;
use JMS\OldSerializer\Annotation\XmlKeyValuePairs;
use JMS\OldSerializer\Annotation\XmlElement;
use JMS\OldSerializer\Annotation\PostSerialize;
use JMS\OldSerializer\Annotation\PostDeserialize;
use JMS\OldSerializer\Annotation\PreSerialize;
use JMS\OldSerializer\Annotation\VirtualProperty;
use Metadata\MethodMetadata;
use Doctrine\Common\Annotations\Reader;
use JMS\OldSerializer\Annotation\Type;
use JMS\OldSerializer\Annotation\Exclude;
use JMS\OldSerializer\Annotation\Groups;
use JMS\OldSerializer\Annotation\Expose;
use JMS\OldSerializer\Annotation\SerializedName;
use JMS\OldSerializer\Annotation\Until;
use JMS\OldSerializer\Annotation\Since;
use JMS\OldSerializer\Annotation\ExclusionPolicy;
use JMS\OldSerializer\Annotation\Inline;
use JMS\OldSerializer\Annotation\ReadOnly;
use JMS\OldSerializer\Metadata\ClassMetadata;
use JMS\OldSerializer\Metadata\PropertyMetadata;
use JMS\OldSerializer\Metadata\VirtualPropertyMetadata;
use JMS\OldSerializer\Exception\InvalidArgumentException;
use JMS\OldSerializer\Annotation\XmlAttributeMap;
use Metadata\Driver\DriverInterface;
use JMS\OldSerializer\Annotation\MaxDepth;
