...
namespace JMS\OldSerializer\EventDispatcher\Subscriber;

use JMS\OldSerializer\EventDispatcher\Event;
use JMS\OldSerializer\EventDispatcher\EventSubscriberInterface;
use JMS\OldSerializer\Exception\ValidationFailedException;
